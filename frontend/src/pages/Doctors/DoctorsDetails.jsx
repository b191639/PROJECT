...
const DoctorsDetails = () => {
  ...
  if (!doctor) return null; // Handle case when doctor data is not yet available
        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                <span className="bg-[#CCF0F3] text-irishBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded">
