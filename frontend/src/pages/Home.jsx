     ...
     <section>
      <div className='container'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
            ...
            <p className='text-[16px] leading-7 textColor font-[400] mt-4 text-center'>World-class care for everyone.Our health System offers un matched,expert health care.From the lab to the clinic.
            </p>
            <Link to='/doctors' className="w-[44px] h-[44px] rounded-full border border-solid 
            border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center 
        ...
        <div className="flex items-center justify-between flex-col lg:flex-row">
          <div className="xl:w-[670px]">
            ...
            <ul className='pl-4'>
              ...
              <li className="text_para">3.View our physicians who  are accepting new patients,use the online scheduling tool to select
            ...
            md:left-5 z-20 p-2 pb-3 lg:px-4 lg:pb-[26px] rounded-[10px]">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-[6px] lg:gap-3">
                  ...
                  font-[600]'>Tue 24</p>
                  <p className='text-[10px] leadinng-[10px] lg:leading-5 text-textColor font-[400]'>10:00AM</p>
                </div>
              ...
              px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:leading-4 text-irishBlueColor font-[500] mt-2 lg:mt-4">Consultation</div>
