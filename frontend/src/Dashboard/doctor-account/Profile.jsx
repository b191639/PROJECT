...
const Profile = ({doctorData}) => {
    ...
    //reusable functio for adding item
    const addItem=(key,item)=>{
        setFormData(prevFormData=>({...prevFormData, [key]:[...prevFormData[key],item]}))
    }
    //reuable input change func
    ...
    const addExperience =e =>{
        e.preventDefault()
        addItem('experiences',{
            startingDate:'',endingDate:'',position:'Senior Surgeon',hospital:'Appolo',
        })
    }
        ...
        <div className="mb-5">
         ...
         <div className="mb-5">
            ...
            <div key={index}>
                ...
                className='bg-[#000] py-2 px-5 rounded text-white h-fit'> Add Experiences </button>
         </div>
         <div className="mb-5">
            ...
            <div key={index}>
                <div>
                    <div className="grid grid-cols-2  md:grid-cols-4 mb-[30px] gap-5">
                        ...
                        <div>
                            <p className='form_label'>EndingTime</p>
         ...
         <div className="mt-7">
            ...
            loading-[30px] w-full py-3 px-4 rounded-lg ">Update Profile</button>
         </div>
